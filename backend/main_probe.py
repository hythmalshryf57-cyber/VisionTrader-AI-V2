...
print("[PROBE-1] importing database", flush=True)
from database import get_db, engine, SessionLocal, create_tables
print("[PROBE-2] importing supabase_client", flush=True)
...
print("[PROBE-11] importing ai_core (AIService init will run!)", flush=True)
from services.ai_core import ai_core_service
from middleware import SecurityMiddleware, TrialMiddleware
print("[PROBE-3] importing auto_scanner", flush=True)
from services.auto_scanner import auto_scanner
print("[PROBE-4] importing cache_service", flush=True)
from services.cache_service import cache_service
print("[PROBE-5] importing vector_memory", flush=True)
...
print("[PROBE-6] importing trade_manager", flush=True)
from services.trade_manager import trade_manager_service
print("[PROBE-7] importing trade_protection", flush=True)
from services.trade_protection import trade_protection_service
print("[PROBE-8] importing market_protection", flush=True)
from services.market_protection import market_protection_service
print("[PROBE-9] importing deep_market", flush=True)
from services.deep_market import deep_market_scanner
print("[PROBE-10] importing calendar_service", flush=True)
